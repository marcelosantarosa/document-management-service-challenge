...
public class DocumentManagementController {
  ...
  private UploadDocumentRequest convertAndValidateJson(String metadata) {
    try {
      UploadDocumentRequest uploadDocument =
          objectMapper.readValue(metadata, UploadDocumentRequest.class);

      BeanPropertyBindingResult bindingResult =
          new BeanPropertyBindingResult(
              uploadDocument, UploadDocumentRequest.class.getSimpleName());
