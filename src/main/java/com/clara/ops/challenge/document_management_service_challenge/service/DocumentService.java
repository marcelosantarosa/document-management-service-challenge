...
public class DocumentService {
  ...
  public PaginatedDocumentSearchResponse searchDocuments(
      Integer page, Integer size, List<String> sort, DocumentSearchFiltersRequest request) {
    Pageable pageable = PageRequest.of(page, size, createSort(sort));
    Page<Document> documents =
        repository.searchByFilters(
            request.getUser(), request.getName(), request.getTags(), pageable);
